...
public class ConfigurationDirectoryAlreadyExistsException extends FileAlreadyExistsException {

    public ConfigurationDirectoryAlreadyExistsException(final Path directory) {
