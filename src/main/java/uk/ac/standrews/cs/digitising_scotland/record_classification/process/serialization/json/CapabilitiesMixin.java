...
public abstract class CapabilitiesMixin {
    ...
    @JsonIgnore
    public abstract Capabilities getClassCapabilities();

    @JsonIgnore
    public abstract Capabilities getAttributeCapabilities();

    @JsonIgnore
    public abstract Capabilities getOtherCapabilities();
}
